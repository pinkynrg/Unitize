module Unitize
  # A Unit is essentially a collection of Unitize::Term. Terms can be combined
  ...
  class Unit
    ...
    # @param other [Unitize::Unit, Unitize::Term, Numeric]
    # @return [Unitize::Unit]
    # @api public
    def *(other)
      operate('*', other) ||
    ...
    # Primarily used by Unitize::Search.
    # @return [Array]
    # @api public
    def aliases
      [:names, :primary_code, :symbol].map do |mode|
        to_s(mode)
      end.uniq
    end
    memoize :aliases
