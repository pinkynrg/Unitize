module Unitize
  # A Unitize::Scale represents a value and a unit, sort of like a vector, it
  ...
  class Scale
    ...
    # Set the unit vector.
    # @param value [String, Unitize::Unit]
    # @api public
    def unit=(value)
    ...
    # @return [Array] An array of Unitize::Term
    # @api public
    def root_terms
      unit.root_terms
    end
